...
integration-file:
	go test -race -cover -v -tags=integration ./integration/file/...

integration-s3:
	go test -race -cover -v -tags=integration ./integration/s3/...

# Run metadata tests without DB tests (skips DB_DSN-dependent tests)
integration-metadata:
	DB_DSN="$(DB_DSN)" go test -race -cover -v -tags=integration ./integration/metadata/...

integration-manager:
	go test -race -cover -v -tags=integration ./integration/manager/...
